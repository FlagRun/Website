...
ActiveRecord::Schema.define(version: 20140407061639) do
  ...
  add_index "forum_posts", ["deleted_at"], name: "index_forum_posts_on_deleted_at", using: :btree
